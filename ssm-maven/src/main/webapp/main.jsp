...
<head>
    ...
    <script type="text/javascript">
        ...
        function test(num){
        	var url = '${pageContext.request.contextPath}/studyEI/1.do?str='+num;
    ...
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 20px">
                <font color="grey" size="10">EasyUI demo</font>
            </div>
             <div align="center" style="padding-top: 20px">
                <font color="grey" size="5" id = "test" ><a href = 'javascript:test("")'>基础开关面板</a></font>
            </div>
            <div align="center" style="padding-top: 20px">
                <font color="grey" size="5" id = "test" ><a href = 'javascript:test(1)'>流式面板</a></font>
            </div>
